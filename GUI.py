...
class CijTable(QTableWidget):
    ...
    def SetData(self):
        self.setItem(0,0, QTableWidgetItem("298(13.00)"))
        ...
        self.setItem(1,1, QTableWidgetItem("298(13.00)"))
        ...
        self.setItem(2,2, QTableWidgetItem("298(13.00)"))
...
# =============================================================================
    ...
    def calculate(self):
        ...
        f = self.text.font()
        f.setPointSize(13.5) # sets the size to 27
        self.text.setFont(f)
